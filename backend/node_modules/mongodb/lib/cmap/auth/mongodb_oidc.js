...
try {
    const dirPath = path.join(__dirname, 'mongodb_oidc');
    console.log('Checking directory:', dirPath);
    console.log(fs.readdirSync(dirPath)); // List contents of the mongodb_oidc directory

    const k8sMachineWorkflow = require('./mongodb_oidc/k8s_machine_workflow');
    console.log('Module loaded successfully:', k8sMachineWorkflow);
} catch (error) {
